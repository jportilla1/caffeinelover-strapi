...
export interface ApiCoffeeShopCoffeeShop extends Struct.CollectionTypeSchema {
...
export interface ApiTutorialTutorial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    titleVideo: Schema.Attribute.String & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::coffee-shop.coffee-shop': ApiCoffeeShopCoffeeShop;
